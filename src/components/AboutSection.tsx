    ...
    <section id="about" className="py-24 relative overflow-hidden bg-slate-50">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-6 drop-shadow-sm">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="bg-white rounded-3xl p-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex overflow-x-auto no-scrollbar">
              {Object.keys(tabContent).map((key) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-4 rounded-2xl font-semibold text-sm transition-all duration-300 relative whitespace-nowrap ${
                      isActive ? "text-white shadow-md transform scale-[1.02]" : "text-slate-500 hover:text-slate-800 hover:bg-slate-50"
                    }`}
                  >
                    {isActive && (
                      <div className="absolute inset-0 bg-gradient-to-r from-[#00629b] to-[#0089c4] rounded-2xl transition-all duration-300 -z-10" />
                    )}
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_40px_rgb(0,0,0,0.06)] border border-slate-100 min-h-[320px] flex flex-col justify-center relative overflow-hidden group">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00629b]/10 to-transparent flex items-center justify-center mb-6 border border-[#00629b]/20 shadow-sm">
                {(() => {
          ...
          <div className="lg:col-span-7 grid md:grid-cols-2 gap-6 relative">
            ...
            {features.map((f, i) => (
              <div 
                key={f.title} 
                className={`bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-500 group hover:-translate-y-2 relative overflow-hidden`}
              ...
              >
                ...
                <div className={`w-14 h-14 rounded-2xl ${f.bg} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 shadow-sm border border-white/50`}>
                  <f.icon className={`h-7 w-7 ${f.text}`} />
                </div>
                <h3 className="font-heading text-xl font-bold text-slate-800 mb-3 group-hover:text-slate-900 transition-colors">{f.title}</h3>
                <p className="text-slate-500 text-base leading-relaxed group-hover:text-slate-600 transition-colors">{f.desc}</p>
                
                {/* Decorative corner element */}
                <div className={`absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-tl ${f.color} opacity-0 group-hover:opacity-10 rounded-full blur-2xl transition-all duration-500`} />
              </div>
            ))}
          </div>
        ...
        <div className="mt-20 md:mt-32 max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-slate-200/60 bg-white shadow-xl rounded-3xl p-6 md:p-8 border border-slate-100">
           <div className="flex flex-col items-center justify-center p-4">
              <span className="text-4xl md:text-5xl font-black text-slate-800 mb-2">24<span className="text-[#00629b]">+</span></span>
              <span className="text-xs md:text-sm font-semibold text-slate-500 uppercase tracking-widest text-center">Years Legacy</span>
           </div>
           <div className="flex flex-col items-center justify-center p-4">
              <span className="text-4xl md:text-5xl font-black text-slate-800 mb-2">500<span className="text-[#00629b]">+</span></span>
              <span className="text-xs md:text-sm font-semibold text-slate-500 uppercase tracking-widest text-center">Members</span>
           </div>
           <div className="flex flex-col items-center justify-center p-4">
              <span className="text-4xl md:text-5xl font-black text-slate-800 mb-2">60<span className="text-[#00629b]">+</span></span>
              <span className="text-xs md:text-sm font-semibold text-slate-500 uppercase tracking-widest text-center">Annual Events</span>
           </div>
           <div className="flex flex-col items-center justify-center p-4">
              <span className="text-4xl md:text-5xl font-black text-slate-800 mb-2">12<span className="text-[#00629b]">+</span></span>
